...
<CardGroup cols={2}>
  <Card title="Conectar instância" icon="whatsapp" href="https://mintlify.com/docs/quickstart">
    Este guia passo a passo mostra como conectar sua conta do WhatsApp ao CRM
  </Card>
